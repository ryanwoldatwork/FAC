...
class TestDissemAPITribalAccess(TestCase):
    # We can force a UUID locally that would not work when using api.data.gov,
    # because api.data.gov sets/overwrites this.
    api_user_uuid = "01ba59b2-f545-4c2f-9b24-9655c706a06c"
    dissemination_api_version = "dissemination_api_v1_0_3" #TODO: update to v1.1.0 when it's ready
    ...
    def test_assert_fails_with_bad_user_id(self):
        ...
        response = requests.post(
            ...
            headers={
                ...
                "content-profile": TestDissemAPITribalAccess.admin_api_version,
    ...
    def test_cannot_find_without_access(self):
        ...
        response = requests.post(
            ...
            headers={
                ...
                # We can force a UUID locally that would not work when using api.data.gov,
                # because api.data.gov sets/overwrites this.
                "x-api-user-id": TestDissemAPITribalAccess.api_user_uuid,
            },
            timeout=10,
        ...
        response = requests.get(
            ...
            headers={
                "authorization": f"Bearer {self.encoded_jwt}",
                "accept-profile": TestDissemAPITribalAccess.admin_api_version,
                "x-api-user-id": "not-a-user-id",
            },
            timeout=10,
        )
